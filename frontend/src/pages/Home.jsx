  ...
  return (
    <div>
      ...
      <div style={styles.hero}>
        ...
        {/* Background image — the floral/botanical pattern image */}
        ...
        <div style={styles.heroContent}>
          ...
          <p style={styles.heroBy}>
            𝒷𝓎 𝓒𝓪𝓹𝓽 𝓐𝓭𝓲𝓽𝓲 𝓢𝓪𝓶𝓪𝓷𝓽
            </p>
        ...
        {loading ? (
          ...
          <div style={styles.grid}>
            {products.map((product, index) => (
              <div key={product._id} style={{ ...styles.card, animationDelay: `${index * 0.1}s` }} className="fade-in">
  ...
  <div style={styles.contactGrid}>
    ...
    <div style={styles.contactCard}>
      <div style={styles.contactIconBox}>
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          ...
          <path d="M9 11c0 3 2 5 5 5 0-1-.5-1.5-1-2l-1 .5C11 14 10 13 10 12l.5-1C10 10.5 9.5 10 9 10v1z" stroke="#C9A84C" strokeWidth="1"/>
        </svg>
      </div>
    ...
    <div style={styles.contactCard}>
      ...
      <style>{`
        ...
        .hero-logo-anim { animation: logoPulse 4s ease-in-out infinite; }
        .hero-title-anim { animation: heroReveal 1s ease 0.3s both; }
        .hero-divider-anim { animation: heroReveal 1s ease 0.6s both; }
        .hero-by-anim { animation: heroReveal 1s ease 0.8s both; }
        .hero-tagline-anim { animation: heroReveal 1s ease 1s both; }
        .hero-btn-anim { animation: heroReveal 1s ease 1.2s both; }
      `}</style>
    </div>
  );
};
...
const styles = {
  ...
  heroOverlay: {
    position: 'absolute',
    inset: 0,
    background: 'rgba(42, 8, 14, 0.62)',   // deep maroon overlay — adjust opacity to taste
    zIndex: 1,
  },
  heroContent: {
    position: 'relative',
  ...
  heroLogo: {
    ...
    // renders SVG in gold on dark background
