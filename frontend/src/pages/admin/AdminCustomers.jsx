              ...
              <div key={order._id} style={styles.card}>
                <div style={styles.cardTop}>
                  ...
                  <div>
                    ...
                    <a
                      href={`mailto:${order.customerEmail}?subject=Your Order - The Varneeka Woman&body=Hello ${order.customerName},%0D%0A%0D%0A`}
                      style={styles.customerEmailLink}
                    >
                      {order.customerEmail}
                    </a>
...
const styles = {
  ...
  orderProductImg: { width: '56px', height: '56px', objectFit: 'cover', flexShrink: 0 },
