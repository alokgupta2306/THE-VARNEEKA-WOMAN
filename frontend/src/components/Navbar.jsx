...
const Navbar = ({ cartCount = 0 }) => {
  ...
  return (
    ...
    <span style={styles.logoName}><b>THE VARNEEKA WOMAN</b></span>
        </Link>

        {/* Desktop Links */}
        <div style={styles.links}>
          <Link to="/" style={styles.link}><h2><b>Home</b></h2></Link>
          <span style={styles.link} onClick={() => scrollTo('about')}><h2><b>About</b></h2></span>
          <span style={styles.link} onClick={() => scrollTo('contact')}><h2><b>Contact Us</b></h2></span>

          {user && user.role === 'admin' && (
            <>
              <Link to="/admin/products" style={styles.link}><h2><b>Add Saree</b></h2></Link>
              <Link to="/admin/orders" style={styles.link}><h2><b>Orders</b></h2></Link>
              <Link to="/admin/analytics" style={styles.link}><h2><b>Analytics</b></h2></Link>
            </>
          )}
        </div>
        ...
        <div style={styles.icons}>
          {user ? (
            <>
              ...
              <Link to="/account" style={styles.iconBtn}>👤</Link>
              <button onClick={handleLogout} style={styles.logoutBtn}><b>Logout</b></button>
            </>
          ) : (
            <>
              <Link to="/login" style={styles.loginBtn}><b>Login</b></Link>
              <Link to="/register" style={styles.registerBtn}><b>Register</b></Link>
            </>
          )}
...
const styles = {
  ...
  logoImg: { height: '50px', objectFit: 'contain' },
